      ...
      >
        ...
        <AnimatePresence>
          <motion.div
            ...
            transition={springConfig}
            className="shadow-3xl border-[#E9E8EF] bg-white transition-colors duration-500 dark:border-white/5 dark:bg-[#1c1c1c]"
          >
              ...
              <DataRow icon={<Flag size={16} />} label="Founders">
                <div className="flex flex-wrap items-center justify-end gap-2">
                  {founders.map((f, i) => (
                    ...
                    >
                      <img src={f.avatar} className="h-5 w-5 rounded-full object-cover" alt="" />
