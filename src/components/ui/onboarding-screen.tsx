...
import { OnBoardingFormStep1 } from '#/features/OnBoardingForm/Step1/AccountsNamesLabels';
  ...
  return (
    <div className="flex min-h-full h-screen my-auto w-full flex-col items-center justify-center bg-transparent transition-colors duration-500">
      <motion.div
        ...
        transition={spring}
        className="flex w-full max-w-sm flex-col overflow-hidden rounded-[32px] border bg-white p-2 shadow-xl transition-colors duration-500 md:h-150 md:max-w-[50%] md:flex-row dark:bg-[#0A0A0A]"
      >
        {/* Left Section */}
        <div className="flex flex-[1.2] flex-col justify-center rounded-[26px] border border-black/5 bg-[#FAFAFA] px-8 py-10 transition-colors duration-500 md:rounded-l-[26px] md:rounded-r-none md:border-r-0 md:px-16 dark:border-white/10 dark:bg-[#131313]">
          <div className="mx-auto w-full max-w-sm">
            ...
            {/* Step 1 */}
            {currentStep === 1 && (
              <OnBoardingFormStep1 businessNameLabel={businessNameLabel} businessNamePlaceholder={businessNamePlaceholder} legalNameLabel={legalNameLabel} legalNamePlaceholder={legalNamePlaceholder} businessName={businessName} setBusinessName={setBusinessName} legalName={legalName} setLegalName={setLegalName} />
            )}
