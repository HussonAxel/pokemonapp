...
import type { DeploymentData } from "./ui/deployment-card";
import { DeploymentCard } from "./ui/deployment-card";
...
export const mockDeploymentData: DeploymentData = {
  ...
  duration: "12m 27s",
  lastActive: "25m ago",
  domains: ["axiom.xyz", "main.axiom-zero.pages.dev", "8f3c2a1.axiom-zero.pages.dev"],
  branch: "MAIN",
  commitHash: "8f3c2a1",
...
const DeploymentCardDemo: React.FC = () => {
  return <DeploymentCard data={mockDeploymentData} />;
};
