import SelectWithAvatar from "#/features/OnBoardingForm/Step 1/selectWithAvatar";
  ...
  return (
    <div className="mb-10 space-y-6 text-left">
      <div className="space-y-2">
        ...
        <SelectWithAvatar data={pokemonGames} param={"game"} />
      </div>
      ...
      <div className="space-y-2">
        ...
        <SelectWithAvatar data={pokemonNames} param={"pokemon"} />
      </div>
    </div>
  );
};
