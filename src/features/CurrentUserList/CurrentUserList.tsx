...
const MOCK_INTEGRATIONS = [
  {
    ...
    description:
      "Send notifications to Slack channels or users when specific events occur in your workflow.",
  ...
  },
  {
    ...
    description:
      "Automate your Discord server by sending rich media messages and managing member roles.",
  ...
  },
  {
    ...
    description:
      "Connect your development workflow to trigger actions on new commits or pull requests.",
...
export default function CurrentUserList() {
  return <IntegrationsCard title="Connected Apps" items={MOCK_INTEGRATIONS} />;
}
